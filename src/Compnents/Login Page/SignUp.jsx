...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-white font-sans text-slate-800">
      ...
      {/* LEFT SECTION - FORM */}
      {/* Adjusted padding for mobile (p-6) vs desktop (p-24) */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 lg:p-24 relative">
        ...
        <div className="w-full max-w-md mt-10 lg:mt-0">
          ...
          {/* Social Login Buttons - Flex Col on Mobile, Row on Tablet+ */}
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            {/* Live Captcha - Responsive Stack */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="bg-gray-50 p-2 rounded-lg w-full sm:w-auto flex justify-center border border-gray-200 overflow-hidden">
                <LoadCanvasTemplate />
              </div>
            ...
            <div className="w-full bg-[#6b0f44] hover:bg-[#520b33] text-white font-medium py-3.5 rounded-xl transition-all shadow-lg shadow-[#6b0f44]/20 active:scale-[0.98]">
              <input type="submit" value="Sign Up" className="w-full cursor-pointer h-full" />
            </div>
          </form>

          {/* Footer */}
          <div className="mt-8 text-center text-sm text-gray-600">
             Already have an account? <Link to="/login" className="font-semibold text-[#6b0f44] hover:underline">Log in</Link>
          </div>
