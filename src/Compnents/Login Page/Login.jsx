...
const LoginPage = () => {
  ...
  return (<div className="min-h-screen w-full flex bg-white font-sans text-slate-800">
    {/* LEFT SECTION */} <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 md:px-12 lg:px-24 py-12"> <div className="w-full max-w-md">
      {/* Logo */} <div className="flex items-center justify-center gap-2 mb-8"> <div className="bg-[#6b0f44] p-1.5 rounded-md text-white"> <Home size={20} fill="currentColor" /> </div> <span className="text-2xl font-bold text-[#6b0f44]">WiztecBD</span> </div>
      ...
      <Slide direction="down" in={alert.open} mountOnEnter unmountOnExit>
        <Stack sx={{ width: '100%', mb: 4 }}>
          <Alert
            ...
            sx={{
              bgcolor:
                alert.type === 'success' ? '#6b0f44' :
                  alert.type === 'error' ? '#b00020' :
                    '#fbc02d',
              color: 'white',
              fontWeight: 500,
      ...
      <form onSubmit={handleLogin} className="space-y-5">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <input type="text" name="captcha" placeholder="Enter Captcha"
            className="w-1/2 bg-gray-50 border-none rounded-xl px-4 py-3.5 text-sm focus:ring-2 focus:ring-[#6b0f44]/20 focus:outline-none transition-all" />
        </div>
